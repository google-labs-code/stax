...
@Getter
@Setter
public class MoveAllChatsRequestDTO {
  @Schema(
      description = "The ID of the source object from which chats will be moved.",
  ...
  @Schema(
      description = "The ID of the objects to which chats will be moved.",
      requiredMode = Schema.RequiredMode.REQUIRED,
