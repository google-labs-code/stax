...
public abstract class BaseWorkbookRowDTO implements Taggable {
  ...
  @Schema(
      ...
      example = "Hello {{variable.provider}}")
  ...
  @JsonProperty("thinking_output")
  @Schema(description = "Output text from the model", example = "I'm doing well, thank you!")
  private String modelThinkingOutputText;
  ...
  public BaseWorkbookRowDTO(ChatTurn chatTurn) {
    if (chatTurn == null) {
      return;
    }
    ...
    this.modelThinkingOutputText =
        chatTurn.getModelResponse() == null ? "" : chatTurn.getModelResponse().getThinking();
    ...
    if (chatTurn.getModelResponse() != null) {
      ...
      if (modelResponse.getScores() != null && !modelResponse.getScores().isEmpty()) {
        ...
        this.llmEvaluations = helper.getLLMScores();
      }
  ...
  @Override
  public abstract TagLinkTargetType getTagLinkTargetType();
}
