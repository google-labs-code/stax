...
public interface ChatTurnService {
  ...
  ChatTurn getChatTurn(String id, User user);

  void updateExpectedOutput(String chatTurnId, User user, String expectedOutput);

  List<ChatTurn> findByChatIn(List<Chat> chat);
}
