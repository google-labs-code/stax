...
@Getter
public class EvaluationScoreHelper {
  private Map<String, String> scores = new HashMap<>();
  private List<ScoreV2> scoresList;
  private Map<String, String> evaluationStatuses = new HashMap<>();

  public static final String normalizationPattern = "[^a-zA-Z0-9]";

  public EvaluationScoreHelper(List<ScoreV2> scores) {
    ...
    for (ScoreV2 score : scores) {
      ...
      this.scores.put(
          evaluatorName,
          score.getScoreData() != null ? score.getScoreData().toString() : score.getLlmResponse());
      this.evaluationStatuses.put(evaluatorName, evaluationStatusValue);
    }
  }

  public Map<String, LLMEvaluationDTO> getLLMScores() {
    ...
    scoresList.forEach(
        score -> {
          if (score.getLlmEvaluator() != null) {
            ...
            String scoreValue =
                score.getScoreData() != null ? score.getScoreData().toString() : null;
  ...
  private void setFailureReason(ScoreV2 score, LLMEvaluationDTO llmScoreDTO) {
