...
public interface ModelResponseService {
  ModelResponse saveModelResponse(ModelResponse modelResponse);

  ModelResponseDTO getModelResponse(User user, String modelResponseId);

  void deleteById(User user, String id);

  void deleteByContainer(EvaluationContainer evaluationContainer);

  ModelResponse createModelResponse(User user, EvaluationContainer container, Model model);
}
