...
public interface InferenceMonitoringService {
  InferenceMonitoring save(InferenceMonitoring inferenceMonitoring);

  void clearEvaluatiionContainerReference(EvaluationContainer container);

  InferenceMonitoring saveInferenceMonitoring(
      User user,
