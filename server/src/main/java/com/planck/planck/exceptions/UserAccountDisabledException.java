...
/**
 * Thrown when the user account attempting to log in or perform an action has been administratively
 * disabled.
 */
public class UserAccountDisabledException extends RuntimeException {

  public UserAccountDisabledException() {
    super("Account Disabled: Your account is currently disabled.");
  }
