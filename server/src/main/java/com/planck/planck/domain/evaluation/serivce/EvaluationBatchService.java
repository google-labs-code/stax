...
public interface EvaluationBatchService {
  String processProject(
      List<String> chatTurnIds, List<String> evaluatorIds, String projectId, User user);

  String processDataSet(
      List<String> chatTurnIds, List<String> evaluatorIds, String dataSetId, User user);

  String processChatTurns(List<String> chatTurnIds, List<String> evaluatorIds, User user);
