...
package com.planck.planck.domain.modelinput;
...
public class ModelInputController {
  ...
  @GetMapping("/{modelInputId}")
  public ResponseEntity<ModelInputDTO> getModelInput(
      @AuthenticationPrincipal User user, @PathVariable String modelInputId) {
    ModelInputDTO modelInput = modelInputService.getModelInput(user, modelInputId);
