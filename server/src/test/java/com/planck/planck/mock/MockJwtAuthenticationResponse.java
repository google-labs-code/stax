...
public class MockJwtAuthenticationResponse {

  public static JwtAuthenticationResponse createMockJwtAuthenticationResponse() {
  ...
  // Example with a specific token and user details
  public static JwtAuthenticationResponse createMockJwtAuthenticationResponse(
